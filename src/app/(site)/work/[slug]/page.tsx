      ...
      <header className="mb-8">
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1">
            <h1 className="font-display text-4xl font-semibold leading-[1.08] tracking-tight sm:text-5xl">{project.name}</h1>
            <p className="mt-3 text-lg leading-relaxed text-[var(--color-fg-muted)]">{project.tagline}</p>
          </div>
        </div>
